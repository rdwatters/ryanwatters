window.addEventListener('click', switchToVideo, false);

function switchToVideo (e) {
    if(classie.has(e.target,"play-button")){
        var theIframe = document.createElement('iframe'),
        ytUrl = e.target.dataset.videourl,
        parentWrapper = e.target.parentNode;
        classie.add(parentWrapper,'video-wrapper');
        parentWrapper.removeChild();
        console.log(ytUrl);
